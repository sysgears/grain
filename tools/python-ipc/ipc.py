    ...
    while True:
        try:
            try:
                ...
                # There is struct.error (unpack str size does not match format)
                # at the end of reading and unpacking data from a socket-file
                # after "generate" command has been done.
                # The highlighting had correctly generated by Pygments before the error was raised.
                # So in this block, the client socket is closing.
                #
